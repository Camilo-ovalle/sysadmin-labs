---
title: "Lab 07 — SCCM: Patch Management"
description: Configuración del Software Update Point (SUP) con WSUS, Automatic Deployment Rules (ADR), Maintenance Windows y compliance de parches.
sidebar:
  label: "Lab 07: Patch Management"
  badge:
    text: Avanzado
    variant: danger
---
