---
title: "Lab 08 — SCCM: OSD y Task Sequences"
description: PXE Boot, Boot Images (WinPE), captura de imagen de referencia, Task Sequences para bare-metal y OS Refresh con USMT.
sidebar:
  label: "Lab 08: OSD y Task Seq."
  badge:
    text: Experto
    variant: note
---
